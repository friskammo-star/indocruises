...
const partners = [
  {
    ...
    url: "https://www.indocruises.co.id/",
    icon: Globe,
  },
  {
    id: "bali-gapura-marina",
    name: "Bali Gapura Marina",
    role: "Marina & Port Facilities",
    description:
      "Premium marina and port facilities in Bali offering world-class berthing, fueling, and hospitality services for luxury vessels.",
    url: "https://www.baligapuramarina.com/",
    icon: Anchor,
  },
  {
    id: "dnd",
  ...
  },
  {
    ...
    description:
      "Comprehensive marine services and solutions supporting vessel operations across Southeast Asian waters.",
    url: "https://jaladrimarine.my.canva.site/",
    icon: Ship,
  },
]
