...
const stats = [
  { value: 20, suffix: "+", label: "Years of Service Excellence" },
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              PT. IMS, also known as Indocruises Maritime Services, is a premium Indonesian yacht and liveaboard management company focused on vessel operations, charter management, marine hospitality, technical support, and commercial yacht services across Indonesia. Its international team supports private owners and commercial operators with practical expertise developed over decades in Indonesian waters.
            </motion.p>
